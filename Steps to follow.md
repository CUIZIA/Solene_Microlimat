...
<p align="center">
  <img src="/fig/Nusselt model.png" alt="Nusselt convection model" width="90%">
</p>
...
$$
CHTC = U_{10}^b \cdot (a_0 + a_1 \cdot W + a_2 \cdot W^2 + a_3 \cdot W^3 + a_4 \cdot W^4 + a_5 \cdot H + a_6 \cdot H^2 + a_7 \cdot H^3 + a_8 \cdot H^4 \\
+ a_9 \cdot W \cdot H + a_{10} \cdot W \cdot H^2 + a_{11} \cdot W \cdot H^3 + a_{12} \cdot W^2 \cdot H + a_{13} \cdot W^2 \cdot H^2 \\
+ a_{14} \cdot W^2 \cdot H^3 + a_{15} \cdot W^3 \cdot H + a_{16} \cdot W^3 \cdot H^2 + a_{17} \cdot W^3 \cdot H^3)
$$
